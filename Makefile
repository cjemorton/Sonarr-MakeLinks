...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Sonarr::MakeLinks
NAME_SYM = Sonarr_MakeLinks
VERSION = 0.01
...
MAKE = make
FULLEXT = Sonarr/MakeLinks
BASEEXT = MakeLinks
PARENT_NAME = Sonarr
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Sonarr/MakeLinks.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Sonarr/MakeLinks.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Sonarr
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Sonarr
...
TO_INST_PM = lib/Sonarr/MakeLinks.pm
...
DISTNAME = Sonarr-MakeLinks
DISTVNAME = Sonarr-MakeLinks-0.01
...
manifypods : pure_all config  \
	lib/Sonarr/MakeLinks.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3SECTION) --perm_rw=$(PERM_RW) -u \
	  lib/Sonarr/MakeLinks.pm $(INST_MAN3DIR)/Sonarr::MakeLinks.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Make hard links using Sonarr api for tv shows. (Continuing, Ended, Incomplete)'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Sonarr-MakeLinks' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Make hard links using Sonarr api for tv shows. (Continuing, Ended, Incomplete)",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Sonarr-MakeLinks",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Sonarr-MakeLinks" VERSION="0.01">' > Sonarr-MakeLinks.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Make hard links using Sonarr api for tv shows. (Continuing, Ended, Incomplete)</ABSTRACT>' >> Sonarr-MakeLinks.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Sonarr/MakeLinks.pm' 'blib/lib/Sonarr/MakeLinks.pm' 
